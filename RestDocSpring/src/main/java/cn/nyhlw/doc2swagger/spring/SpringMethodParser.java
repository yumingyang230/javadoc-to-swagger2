...
import cn.nyhlw.doc2swagger.core.models.MappingModel;
import cn.nyhlw.doc2swagger.core.models.PathModel;
import cn.nyhlw.doc2swagger.core.parse.IMethodParser;
...
public class SpringMethodParser implements IMethodParser {
    ...
    public PathModel parse(Method method, MethodJavadoc methodJavadoc, PathModel pathModel) {
        ...
        for (var annotation : annotations) {
            ...
            if (annotationType == DubboUri.class) {
//                增加一个自定义注解
                ...
                mappingPaths = dubboMappingAnno.path();
                mappingValues = dubboMappingAnno.value();
            } else if (annotationType == RequestMapping.class) {
                var requestMappingAnno = (RequestMapping) annotation;
                if (requestMappingAnno.method().length == 0) {
